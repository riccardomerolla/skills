...
What this slice exists to deliver, framed from the user's or the calling system's perspective. One short paragraph. Not "we need to implement module X" but "users need to be able to submit orders and receive a receipt".
