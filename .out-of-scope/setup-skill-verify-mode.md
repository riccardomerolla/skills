# Verify/Check Mode for `setup-ricky-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-ricky-skills`.
...
- #106: Feature request: verify/check mode for setup-ricky-skills
